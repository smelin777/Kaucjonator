  ...
  return (
    ...
    >
      ...
      <button
        ...
        style={{ position: "absolute", top: 16, right: 16, width: 40, height: 40, borderRadius: "50%", border: "2px solid rgba(10,10,10,0.7)", background: "rgba(255,255,255,0.75)", cursor: "pointer", fontSize: 18, display: "flex", alignItems: "center", justifyContent: "center", transition: "background 0.15s ease" }}
      >
        ⚙️
      </button>

      {showSettings && (
        <div style={{ position: "absolute", top: 62, right: 16, ...glassCard, borderRadius: 14, padding: "14px 16px", zIndex: 10, animation: "fadeSlideIn 0.18s ease", width: 220 }}>
          {types.map((t) => (
